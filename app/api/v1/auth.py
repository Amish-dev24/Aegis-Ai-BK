...
from app.schemas.user import Token, UserCreate, UserResponse, UserSignup
...
async def login(
    ...
    refresh_token = create_refresh_token(
        data=token_data, expires_delta=timedelta(hours=settings.REFRESH_TOKEN_EXPIRE_HOURS)
    )
